...
Future<void> main() async {
  ...
  test('AT&T Inc.', () {
    var q = r'AT&T INC.';
    var r = fmatch(q);
    expect(r.matchedEntries.length, 0);
  });
  test('Li Na', () {
    var q = r'Li Na';
    var r = fmatch(q);
    expect(r.matchedEntries.length, lessThan(10));
  });
  ...
  test('CIT LLC', () {
    ...
    var r = fmatch(q);
    // expect(r.matchedEntries.length, lessThan(5));
    expect(r.matchedEntries.length, lessThan(20));
  });
  test('CIT Co Ltd', () {
    var q = r'CIT Co Ltd';
    var r = fmatch(q);
  ...
  test('SURA', () {
    var q = r'SURA';
    var r = fmatch(q);
    expect(r.matchedEntries.length, lessThan(55)); // 1語のノイズはやむを得ない
  });
  ...
  test('Medical d o o', () {
    ...
    var r = fmatch(q);
    // expect(r.matchedEntries.length, lessThan(1));
    expect(r.matchedEntries.length, lessThan(60));
  });
  test('H Medical', () {
    var q = r'H Medical';
    var r = fmatch(q);
  ...
  test('M-ASTER', () {
    var q = r'M-ASTER';
    var r = fmatch(q);
    expect(r.matchedEntries.length, lessThan(15));
  });
  test('M ASTER', () {
    var q = r'M ASTER';
    var r = fmatch(q);
  ...
  test('Abdul Qadir', () {
    var q = r'Abdul Qadir';
    var r = fmatch(q);
    expect(r.matchedEntries.length, lessThan(20)); // マッチするのが妥当な名前ばかり
  });
  test('PCI', () {
    var q = r'PCI';
    var r = fmatch(q);
  ...
  test('LLC Orman', () {
    ...
    var r = fmatch(q);
    // expect(r.matchedEntries.length, lessThan(5));
    expect(r.matchedEntries.length, lessThan(100));
  });
  test('DOCTOR AZ Ltd ', () {
  ...
  test('BANK OF KESHAVARZI', () {
    ...
    var r = fmatch(q).matchedEntries.map((e) => e.rawEntry).toList();
  ...
  test('HARBIN INSTITUTE OF TECHNOLOGY', () {
    ...
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'HARBIN INSTITUTE OF TECHNOLOGY (HIT)');
  });
  test('NOVOKUIBYSHEVSK REFYNERY', () {
    var q = r'NOVOKUIBYSHEVSK REFYNERY';
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'NOVOKUIBYSHEVSK REFINERY');
  });
  ...
  test('ASTRONAUTICS SYSTEMS RESEARCH CENTRE', () {
    ...
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'ASTRONAUTICS SYSTEMS RESEARCH CENTER');
  });
  test('BIMEH IRAN INSURANCE COMPANY(UK)LIMITED', () {
    var q = r'BIMEH IRAN INSURANCE COMPANY(UK)LIMITED';
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'BIMEH IRAN INSURANCE COMPANY (U.K.) LIMITED');
  });
  test('OBRONPROM', () {
    var q = r'OBRONPROM';
    var r = fmatch(q);
    expect(r.matchedEntries.length, greaterThan(0));
  });
  test('SIRIUS CO LTD', () {
    ...
    expect(r.matchedEntries.length, lessThan(70));
  });
  ...
  test('Gazpromneft Moscow Refinery Joint Stock Company', () {
    ...
    var r = fmatch(q);
    expect(r.matchedEntries.length, equals(1));
  });
  test('Gazpromneft-MNPZ, AO', () {
    var q = r'Gazpromneft-MNPZ, AO';
    var r = fmatch(q);
    expect(r.matchedEntries.length, equals(2));
  });
  ...
  test('Lukoil Europe Holdings BV', () {
    ...
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'LUKOIL EUROPE HOLDINGS B.V.');
  });
  test('D.I.T. CO., LTD.', () {
    var q = r'D.I.T. CO., LTD.';
    var r = fmatch(q);
    expect(r.matchedEntries[0].rawEntry, 'SAID, ABDELLILLAH DIT ABDELLAH AHMED DIT');
  });
  test('I&I CO., LTD.', () {
    var q = r'I&I CO., LTD.';
    var r = fmatch(q);
    expect(r.matchedEntries, <MatchedEntry>[]);
  });
  test('K&S KOREA', () {
    var q = r'K&S KOREA';
    var r = fmatch(q);
